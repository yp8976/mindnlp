...
class Owlv2VisionModelTester:
    ...
    def create_and_check_model(self, config, pixel_values):
        ...
        pixel_values = pixel_values.astype(mindspore.float32)
    ...
    def _create_and_check_torchscript(self, config, inputs_dict):
        ...
        for model_class in self.all_model_classes:
            ...
            with tempfile.TemporaryDirectory() as tmp_dir_name:
                ...
                try:
                    loaded_model = safe_save_file(pt_file_name)
                except Exception:
...
class Owlv2ModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference(self):
        ...
        self.assertTrue(np.allclose(outputs.logits_per_image.asnumpy(
    ...
    def test_inference_object_detection(self):
        ...
        self.assertTrue(np.allclose(outputs.logits[0, :3, :3].asnumpy(
        ...
        ), expected_slice_boxes, atol=1e-4))
